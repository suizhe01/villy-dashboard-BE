...
class CN(models.Model):
    ...
    branchautokey = models.ForeignKey(Branch,
                                       ...
                                       related_name='CNBranchAutokey'
                                       )
    displayterm = models.ForeignKey(Terms,
                                       models.DO_NOTHING,
                                       db_column='DisplayTerm',
                                       related_name='CNTermsDisplayTerm',
                                       null=False
                                       )
    ...
    # debtorname = models.ForeignKey(Debtor,
    #                                models.DO_NOTHING,
    ...
    isroundadj = models.CharField(max_length=5,db_column='IsRoundAdj', null= False)
