...
def create_dob_mamee_iv_ivdtl_invoice(debtor_code, debtor_name,invoice_no,item_code,invoice_date,quantity,rate,net_amount, uom, seq,price,sales_agent, description, tempcompanyautokey, branchautokey,location, temporary_display_term,lorry_driver,udf_book):
