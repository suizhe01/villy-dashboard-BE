...
def create_mp_iv_ivdtl(debtor_code,debtor_name,sales_agent,invoice_no,invoice_date,item_code,description,uom,quantity,price,discount_amount,net_amount, seq,tempcompanyautokey,branchautokey,location,temporary_display_term,lorry_driver,udf_book2):
