...
def create_dksh_iv_ivdtl(invoice_no,invoice_date,debtor_name,debtor_code,seq,sales_agent,item_code,quantity,uom,discount_amount,net_amount,price,description,temporary_display_term,tempcompanyautokey,branchautokey,location,lorry_driver,udf_book2):
