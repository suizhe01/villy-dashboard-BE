...
def create_dksh_cn_cndtl(cn_no,cn_date,debtor_name,debtor_code,seq,sales_agent,item_code,quantity,uom,discount_amount,net_amount,price,temporary_display_term,tempcompanyautokey,branchautokey,location_instance,description):
