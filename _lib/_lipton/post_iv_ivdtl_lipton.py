...
def create_lipton_iv_ivdtl(debtor_code, debtor_name,invoice_no,invoice_date,item_code,net_amount, quantity, uom,discount_amount,seq,price,sales_agent,temporary_display_term,tempcompanyautokey,branchautokey,location,description,lorry_driver,udf_book2):
