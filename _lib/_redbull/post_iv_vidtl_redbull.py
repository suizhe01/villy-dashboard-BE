...
def create_redbull_iv_ivdtl_invoice(debtor_code, debtor_name,invoice_no,item_code,invoice_date,delivery_date,quantity,total_price,discount_amt,net_amount, uom,seq,price, sales_agent, description, rate, tempcompanyautokey, branchautokey, location, temporary_display_term,lorry_driver,udf_book2):
