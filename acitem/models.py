...
class AcItem(models.Model):
    ...
    itemcode = models.CharField(max_length=30,db_column='ItemCode', null= False, unique=True)
...
@receiver(pre_save, sender=AcItem)
def pre_save_ac_item(sender, instance, **kwargs):
