...
class AcItemUOM(models.Model):
    autokey = models.CharField(primary_key=True, db_column='Autokey',max_length=32, editable=False, unique=True)
    itemcode = models.CharField(max_length=30,db_column='ItemCode', null= False)
    
    # new column UDF
    udfcalmethod = models.CharField(max_length=8,db_column='UDF_CalMethod', null= True)
    udfcalrate = models.DecimalField(db_column='UDF_CalRate', max_digits=2, decimal_places=2, null=True)
...
@receiver(pre_save, sender=AcItemUOM)
