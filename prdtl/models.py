...
class PRDTL(models.Model):
    ...
    prautokey = models.ForeignKey(PR,
                                       models.DO_NOTHING,
                                       db_column='PRAutoKey',
                                       related_name='PRDTLPIAutokey'
                                       )
    itemcode = models.ForeignKey(Item,
                                       models.DO_NOTHING,
                                       db_column='ItemCode',
                                       related_name='PRDTLItemCodeAutokey',
                                       null=True,
                                       to_field='itemcode'
                                       )
    location = models.ForeignKey(Location,
                                       models.DO_NOTHING,
                                       db_column='Location',
                                       related_name='PRDTLLocationAutokey',
                                       null=True,
                                       to_field='location'
                                       )
    ...
    yourdono = models.CharField(max_length=20,db_column='YourDONo', null= True)
...
@receiver(pre_save, sender=PRDTL)
