...
class GR(models.Model):
    ...
    creditorname = models.ForeignKey(Creditor,
                                ...
                                related_name='GRCreditorCompanyName',
                                null=False,
    ...
    createdtimestamp = models.DateTimeField(db_column='CreatedTimeStamp', null = False,auto_now=True)
...
def pre_save_company(sender, instance, **kwargs):
    ...
    if not instance.docno:
        last_gr = GR.objects.order_by('docno').last()
        if last_gr:
        ...
        instance.docno = f'GR-{doc_number}'