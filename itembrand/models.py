...
class ItemBrand(models.Model):
    ...
    companyautokey = models.ForeignKey(Company,
                                       ...
                                       related_name='ItemBrandCompanyAutokey'
                                       )
    itembrand = models.CharField(max_length=20,db_column='ItemBrand', null= False)
    ...
    note = models.CharField(max_length=40,db_column='Note', null= True)
...
@receiver(pre_save, sender=ItemBrand)
