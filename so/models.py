...
class SO(models.Model):
    ...
    branchautokey = models.ForeignKey(Branch,
                                       ...
                                       related_name='SOBranchAutokey'
                                       )
    displayterm = models.ForeignKey(Terms,
                                       models.DO_NOTHING,
                                       db_column='DisplayTerm',
                                       related_name='SOTermsDisplayTerm',
                                       null=False
                                       )
    ...
    Debtorname = models.CharField(max_length=100,db_column='CreditorName', null= True)
    ...
    cantransferbyvalue = models.CharField(max_length=1,db_column='CanTransferByValue', null= True)
    transferedamt = models.DecimalField(max_digits=19, decimal_places=2, db_column='TransferedAmt', null=True)
