...
class GRDTL(models.Model):
    ...
    headerautokey = models.ForeignKey(GR,
                                       models.DO_NOTHING,
                                       db_column='HeaderAutoKey',
                                       related_name='GRDTLGRAutokey',
                                       to_field='autokey'
                                       )
    itemcode = models.ForeignKey(Item,
                                       models.DO_NOTHING,
                                       db_column='ItemCode',
                                       related_name='GRDTLItemCodeAutokey',
                                       to_field='itemcode'
                                       )
    location = models.ForeignKey(Location,
                                       models.DO_NOTHING,
                                       db_column='Location',
                                       related_name='GRDTLLocationAutokey',
                                       to_field='location'
                                       )
...
@receiver(pre_save, sender=GRDTL)
