...
class IV(models.Model):
    ...
    salesagent = models.ForeignKey(SalesAgent, 
                                    models.DO_NOTHING,
                                    db_column='SalesAgent',
                                    related_name='IVSalesAgent', 
                                    null= False, 
                                    to_field='salesagent')
    udfbook = models.PositiveSmallIntegerField(db_column='UdfBook',null=True, blank=True)
    lorrydriver = models.CharField(max_length=25, db_column='LorryDriver', null=True)
