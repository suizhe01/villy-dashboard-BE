...
class CreditorType(models.Model):
    ...
    companyautokey = models.ForeignKey(Company,
                                       ...
                                       related_name='CreditorTypeCompanyAutokey'
                                       )
    creditortype = models.CharField(max_length=20,db_column='CreditorType', null= False)
...
@receiver(pre_save, sender=CreditorType)
