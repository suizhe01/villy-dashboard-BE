...
class AcIV(models.Model):
    ...
    #                                    related_name='IVBranchAutokey',
    #                                    to_field='address'
    #                                    )
    dockey = models.CharField(primary_key=True, db_column='DocKey',max_length=32, editable=False, unique=True)
    ...
    debtorcode = models.CharField(max_length=50,db_column='Debtorcode', null= True)
    debtorname = models.CharField(max_length=80, db_column='DebtorName', null=False)
    salesagent = models.CharField(max_length=50,db_column='SalesAgent', null= True)
    ...
    salesexemtionno = models.CharField(max_length=60,db_column='SalesExemptionNo', null= True)
    ...
    totalbonuspoint = models.DecimalField(max_digits=19, decimal_places=2, db_column='TotalBonusPoint', null=True)
    ...
    def get_absolute_url(self):
        return f"/{self.dockey}/"
    
@receiver(pre_save, sender=AcIV)
