...
class AcIVDTL(models.Model):
    dtlkey = models.CharField(primary_key=True, db_column='DtlKey',max_length=32, editable=False, unique=True)
    dockey = models.CharField(max_length=50,db_column='DocKey', null= False)
    itemcode = models.CharField(max_length=50,db_column='ItemCode', null= False)
    focdtlkey = models.BigIntegerField(db_column='FOCDtlKey', null=True)
    location = models.CharField(max_length=50,db_column='Location', null= False)
    ...
    localtotalcost = models.DecimalField(db_column='LocalTotalCost', max_digits=25, decimal_places=8, null=True)
    localfoctotalcost = models.DecimalField(db_column='LocalFOCTotalCost', max_digits=25, decimal_places=8, null=True)
    ...
    ourdono = models.CharField(max_length=20,db_column='OurDONo', null= True)
...
@receiver(pre_save, sender=AcIVDTL)
def pre_save_ac_ivdtl(sender, instance, **kwargs):
