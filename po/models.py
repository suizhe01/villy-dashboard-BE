...
class PO(models.Model):
    ...
    branchautokey = models.ForeignKey(Branch,
                                       ...
                                       related_name='POBranchAutokey'
                                       )
    displayterm = models.ForeignKey(Terms,
                                       models.DO_NOTHING,
                                       db_column='DisplayTerm',
                                       related_name='POTermsDisplayTerm',
                                       null=False
                                       )
    docno = models.CharField(max_length=20,db_column='DocNo', null= False)
    docdate = models.DateTimeField(db_column='DocDate', null=False)
    creditorcode = models.CharField(max_length=12,db_column='CreditorCode', null= True)
    creditorname = models.CharField(max_length=100,db_column='CreditorName', null= True)
    ...
    currencyrate = models.DecimalField(db_column='CurrencyRate', max_digits=19, decimal_places=12, null=False)
