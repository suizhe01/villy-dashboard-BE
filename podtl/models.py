...
class PODTL(models.Model):
    ...
    poautokey = models.ForeignKey(PO,
                                       models.DO_NOTHING,
                                       db_column='POAutoKey',
                                       related_name='PODTLPOAutokey'
                                       )
    itemcode = models.ForeignKey(Item,
                                       models.DO_NOTHING,
                                       db_column='ItemCode',
                                       related_name='PODTLItemCodeAutokey',
                                       null=True
                                       )
    ...
    fromsodoclist = models.CharField(max_length=255,db_column='FromSODocList', null= True)
...
@receiver(pre_save, sender=PODTL)
