...
class PI(models.Model):
    ...
    creditorname = models.ForeignKey(Creditor,
                                ...
                                related_name='PICreditorCompanyName',
                                null=False,
    ...
    supplierdono = models.CharField(max_length=20,db_column='SupplierDONo', null= True)
    supplierinvoiceno = models.CharField(max_length=20,db_column='SupplierInvoiceNo', null= True)
    ...
    foreigncharges = models.DecimalField(db_column='ForeignCharges', max_digits=19, decimal_places=2, null=True)
    localcharges = models.DecimalField(db_column='LocalCharges', max_digits=19, decimal_places=2, null=True)
    landedcostmethod = models.CharField(max_length=1,db_column='LandedCostMethod', null= True)
    ...
    referpaymentdockey = models.BigIntegerField(db_column='ReferPaymentDocKey', null=True)
    transferable = models.CharField(max_length=1,db_column='Transferable', null= False)
    todoctype = models.CharField(max_length=2,db_column='ToDocType', null= True)
    ...
    shipvia = models.CharField(max_length=20,db_column='ShipVia', null= True)
    shipinfo = models.CharField(max_length=40,db_column='ShipInfo', null= True)
    ...
    roundadj = models.DecimalField(max_digits=19, decimal_places=2, db_column='RoundAdj', null=True)
    finaltotal = models.DecimalField(max_digits=19, decimal_places=2, db_column='FinalTotal', null=True)
    selfbilledapprovalno = models.CharField(max_length=30,db_column='SelfBilledApprovalNo', null= True)
...
def pre_save_company(sender, instance, **kwargs):
    ...
    if not instance.docno:
        last_gr = PI.objects.order_by('docno').last()
        if last_gr:
            last_docno = last_gr.docno
            doc_number = int(last_docno.split('-')[-1]) + 1
            print(doc_number)
        else:
            doc_number = 1

        instance.docno = f'PI-{doc_number}'