...
class DNDTL(models.Model):
    ...
    dnautokey = models.ForeignKey(CN,
                                       models.DO_NOTHING,
                                       db_column='DNAutokey',
                                       related_name='DNDTLCNAutokey'
                                       )
    itemcode = models.ForeignKey(Item,
                                       models.DO_NOTHING,
                                       db_column='ItemCode',
                                       related_name='DNDTLItemCodeAutokey',
                                       null=True
                                       )
    location = models.ForeignKey(Location,
                                       models.DO_NOTHING,
                                       db_column='Location',
                                       related_name='DNDTLLocationAutokey',
                                       null=True
                                       )
...
@receiver(pre_save, sender=DNDTL)
